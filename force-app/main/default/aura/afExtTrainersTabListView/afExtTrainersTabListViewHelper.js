({
   ...
   getData : function(component) {
        var userId = $A.get("$SObjectType.CurrentUser.Id");//Something is amiss here...should get external trainer Id
 ...
 addToArray : function(tempObj, endDateString, startDateString){
            var tempArray = {
               ...
               ExternalTrainer: tempObj.External_Trainer__r.First_Name__c
           };
    return tempArray;
},
